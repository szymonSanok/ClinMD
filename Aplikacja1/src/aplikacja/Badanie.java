 ...
 * @author Simon
 */
public class Badanie extends Table {
    ...
    int width = 530, height = 260, pn, wt, sr, cz, pt, idLekarza;
    ...
    Badanie() {
        ...
        try {
            ...
            Logger.getLogger(Badanie.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//      grid.setHalignment(labelWybierz, HPos.RIGHT);
        ...
        toObsList("SELECT imie,nazwisko FROM personelMedyczny");
        ...
        comboLekarz.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                idLekarza = (comboLekarz.getSelectionModel().getSelectedIndex() + 1);
                ...
                try {
                    ...
                    pn = rs.getInt("wartosc"); //uzupełnić klasę edycjaD
        ...
        toObsList("SELECT nazwa FROM zabiegi");
...
String godzina = tableview.getSelectionModel().getSelectedItem().toString();
                ...
                try {
                    ...
                    pst = con.prepareStatement("INSERT INTO badaniaZaplanowane (idPacjenta, idGodziny, idPracownika, czySkierowanie, data, idZabiegu) VALUES(?,?,?,?,?,?);");
                    ...
                    pst.setInt(6, comboSpec.getSelectionModel().getSelectedIndex() + 1);
                    pst.executeUpdate();
                    pst.close();
